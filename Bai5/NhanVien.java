...
public class NhanVien {
    ...
    private final String tenNhanVien;
     // Khai báo các thuộc tính của lớp Nhanvien private String tenNhanVien; // Tên nhân viên private double luongCoBan; // Lương cơ bản private double heSoLuong; // Hệ số lương private static double Luong_max = 10000000; // Lương tối đa
